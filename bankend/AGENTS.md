...
- Redis 保存 AI 任务运行态、进度和运行锁；长任务锁使用 Redisson，持久结果仍写 PostgreSQL。
...
- AI 任务并发可通过 `SCRIPT_GENERATION_MAX_RUNNING_TASKS`、`SCRIPT_GENERATION_MAX_DEEPSEEK_REQUESTS`、`SCRIPT_GENERATION_RUNTIME_TTL_MINUTES` 覆盖，默认分别为 `2`、`3`、`30`。
